...
void Wings::extend(WingSide side) {
    switch (side) {
        case L: leftPiston->set_value(true); break;
        case R: rightPiston->set_value(true); break;
        case B:
...
void Wings::retract(WingSide side) {
    switch (side) {
        case L: leftPiston->set_value(false); break;
        case R: rightPiston->set_value(false); break;
        case B:
